    ...
    <div className="min-h-screen bg-[#1e1e2e] flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#2a2a3a] rounded-2xl border border-[#3a3a4a] p-8">
          <h2 className="chalk-title text-xl text-[#e8e8e8] mb-6">Entrar na sua conta</h2>
          ...
          <p className="mt-6 text-center text-sm text-[#888]">
            Não tem uma conta?{" "}
            <Link href="/register" className="text-[#f0c040] hover:text-[#f0c040]/80 font-medium">Criar conta</Link>
          </p>
        </div>
      </div>
    </div>
