        ...
        >
          ...
          <div className="px-8 py-8">
            <form onSubmit={handleRegister} className="space-y-5">
              <div>
                <label className="block text-[#111] font-bold text-xs uppercase tracking-wider mb-2">Nome completo</label>
                <input
                  type="text"
                  value={name}
            ...
            <p className="mt-6 text-center text-sm text-[#111]/60 font-medium">
              Já tem uma conta?{" "}
              <Link href="/login" className="text-[#111] font-extrabold underline underline-offset-2 hover:no-underline">
                Fazer login
              </Link>
            </p>
          </div>
